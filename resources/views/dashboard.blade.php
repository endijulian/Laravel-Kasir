            ...
            <div class="col-12">
                <div id="custom-search-input">
                    <div class="input-group">
                        <input type="text" id="product" name="product" class="form-control" placeholder="Search">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Daftar Menu Yang di Pesan</h3>
                    </div>
                            ...
                            <tbody>
                                ...
                                @foreach ($tempr_orders as $order)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form action="{{route('tempr_order.destroy', $order->id)}}" method="post">
                                                @csrf
                                                @method('DELETE')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="back" class="form-control" type="text" name="back">
                                    </div>
                                </div>
                            </div>
